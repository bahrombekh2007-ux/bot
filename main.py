...
# Web App URL — GitHub Pages yoki Render URL
WEBAPP_URL = os.getenv("WEBAPP_URL", "https://YOUR_GITHUB_USERNAME.github.io/testmaster/")
...
def main_kb():
    """Soddalashtirilgan 3 tugmali asosiy menyu."""
...
async def main():
    print("🚀 Test Master Bot ishga tushdi")
